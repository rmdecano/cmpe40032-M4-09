...
--UPDATE : to see if there's a match happened
...
--UPDATE: funtion to know if there is no possible match left
...
--UPDATE:function to check if matches found to reswap the tile if not
